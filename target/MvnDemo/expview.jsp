...
<body>
	...
	<table border="1" width=50%>
		...
		<tr>
			...
			%>
			<td style="background-color: red;" data-label="Type"><%=(list.get(i)).getType()%></td>
			<td style="background-color: red;" data-label="Amount"><%=(list.get(i)).getAmt()%></td>
			<td style="background-color: red;" data-label="Date"><%=(list.get(i)).getDateString()%></td>
			<%
			} else {
			%>
	...
	<%
	session.setAttribute("totalexp", totalsum);
	%>
	<%
	...
	<br />
	<h1>
		Total Expenditure is:<%=totalsum%></h1>
	<%
	totalsum = 0;
	%>
